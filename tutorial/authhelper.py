...
client_id = 'c5fe3b31-beab-4cb7-87f6-ff543c8d6dba'
client_secret = 'l=.-4ofJ9sCVb?0F5bw5B28NpnB7UY/1'
...
# The scopes required by the APPEND_SLASH 
...
def get_access_token(request, redirect_uri):
  print("it executed atleast ones")
